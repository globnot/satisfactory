...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      'flex h-11 items-center space-x-1 rounded-base border-2 border-border dark:border-darkBorder bg-bg dark:bg-darkBg p-1',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex cursor-default select-none text-text dark:text-darkText items-center rounded-base border-2 border-transparent px-3 py-1.5 text-sm font-heading outline-none focus:border-border dark:focus:border-darkBorder data-[state=open]:border-border dark:data-[state=open]:border-darkBorder',
      className,
    )}
    {...props}
  />
...
const MenubarShortcut = ({
  ...
  return (
    <span
      className={cn(
        'ml-auto text-xs font-heading tracking-widest text-black dark:text-darkText',
        className,
      )}
      {...props}
    />
