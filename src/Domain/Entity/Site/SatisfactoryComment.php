...
use App\Infrastructure\Persistence\Repository\Site\SatisfactoryCommentRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SatisfactoryCommentRepository::class)]
class SatisfactoryComment
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
